...
- :books: I’m currently learning TSDB, In-Memory DB, Kafka, Container, MSA
...
- :pushpin: **Interests**: Kafka, InfluxDB, OpenTSDB, In-Memory DB, RabbitMQ, Open-Channel SSD, Zoned Storage, NVMe, In-storage Computing, Zoned Namespaces SSD, Kubernetes, Virtualization, RocksDB, LevelDB, OS Kernel, Linux Control Group, Device Driver, Embedded System ...
