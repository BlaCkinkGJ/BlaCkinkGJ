...
- :pushpin: **Interests**: Kafka, InfluxDB, OpenTSDB, In-Memory DB, RabbitMQ, NVMe, Kubernetes, Virtualization, RocksDB, LevelDB, OS Kernel, Linux Control Group, Hypervisor, VictoriaMetrics, Cortex TSDB, Thanos, Grafana Mimir
